...
function Footer() {
    return (
        <section className="relative overflow-hidden py-10 bg-grey-400 border border-t-2 border-t-black">
            <div className="relatice z-10 mx-auto max-w-7xl px-4"> 
                        ...
                        <div className="flex h-full flex-col justify-between">
                            ...
                            <div>
                                <p className="text-sm text-gray-600">
                                    &copy; Copyright 2024. All Rights Reserved by VIP.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div className="w-full p-6 md:w-1/2 lg:w-2/12">
                        <div>
                            ...
                            <ul>
                                ...
                                <li>
                                    <Link className=" text-base font-medium text-gray-900 hover:text-gray-700" to="/" Press Kit />
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div className="w-full p-6 md:w-1/2 lg:w-2/12">
                        <div className="h-full"> 
                            ...
                            <ul>
                                ...
                                <li className="mb-4">
                                    <Link className=" text-base font-medium text-gray-900 hover:text-gray-700" to="/"  Contact Us/>
                                </li>
                                <li>
                    ...
                    <div className="w-full p-6 md:w-1/2 lg:w-3/12">
                        <div className="h-full">
                            ...
                            <ul>
                                ...
                                <li className="mb-4">
                                    <Link className="text-base font-medium text-gray-900 hover:text-gray-700" to="/" Privacy Policy />
                                </li>
                                <li className="mb-4">
